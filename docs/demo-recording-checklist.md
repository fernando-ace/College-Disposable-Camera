# EventFilm Demo Recording Checklist

Use this to record a concise product demo after the deployed release candidate is ready. Do not imply fake customer usage or fake deployed smoke success.

## Setup

- Use a safe demo host account.
...
- No private phone numbers, secrets, database URLs, or service keys appear.
- Any visible event names/photos are approved for demo use.
- The recording shows real app screens, not mocked production claims.
- The demo ends with analytics and moderation visible.
